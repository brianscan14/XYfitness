...
from .views import (
    all_prods, plans, apparel, sort, sort_apparel,
    sort_plans, single_prod, review_prod, delete_prod_review,
    edit_review_prod
)
...
urlpatterns = [
    ...
    url(r'product/review/edit/(?P<pk>\d+)/$',
        edit_review_prod, name='edit_review_prod'
        ),
